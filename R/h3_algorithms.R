...
#' @param h3_addresses Character vector or list of 15-character addresses generated by
#'   H3. Must
#' @param simple Logical; whether to return a single multipolygon or cast the
#'   output to polygon.
...
#'   addresses supplied overlap. It is safest to restrict inputs to the results
#'   of, e.g., a single `h3_get_kring()` call.
#' @examples
...
h3_set_to_multipolygon <- function(h3_addresses = NULL, simple = TRUE) {
  ...
  # addresses overlap, the function outputs invalid polygons. Must have been
  # intended to chain off functions above and not take arbitrary address sets
