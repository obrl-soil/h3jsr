...
test_that('is_valid returns correctly', {
...
test_that('is_pentagon returns correctly', {
...
# is_rc3
test_that('is_rc3 returns correctly', {
...
test_that('get_base_cell returns correctly', {
...
test_that('get_faces returns correctly', {
...
test_that('get_pentagons returns correctly', {
...
test_that('get_res0 returns correctly', {
  res0 <- get_res0()
...
# splitlong_to_cell
test_that('splitlong_to_cell returns correctly', {
  val1 <- cell_to_splitlong('8abe8d12acaffff')
...
# degs to rads
test_that('degs_to_rads returns correctly and consistently', {
...
test_that('rads_to_degs returns correctly and consistently', {
...
test_that('cell_to_childpos returns correctly', {
...
test_that('childpos_to_cell returns correctly', {
...
test_that('cell_to_children_size returns correctly', {
