...
`is_rc3()` checks whether an H3 address has a resolution with Class III orientation. This refers to the [orientation of the hex grid](https://h3geo.org/docs/core-library/coordsystems#faceijk-coordinates) relative to the next coarser resolution. 
